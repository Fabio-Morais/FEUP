...
/**
 *  cria um novo vetor com os mesmos elementos do vetor vec mas guardados em posicoes aleatorias
 *  parametro: vec apontador para vetor
 *  retorno: apontador para novo vetor ou NULL se ocorrer algum erro
 *  nota: o vetor inicial nao deve ser alterado
 */
